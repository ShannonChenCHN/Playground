...
NSString *const kSCGPUImageYUVFullRangeConversionForLAFragmentShaderString = SHADER_STRING
(
...
NSString *const kSCGPUImageYUVVideoRangeConversionForLAFragmentShaderString = SHADER_STRING
(
 varying highp vec2 textureCoordinate;
