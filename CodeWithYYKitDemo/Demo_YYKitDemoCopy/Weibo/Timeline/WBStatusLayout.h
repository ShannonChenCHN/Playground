...
//____以下是数据_______
@property (nonatomic, strong) WBStatus *status;    ///< 微博状态数据
@property (nonatomic, assign) WBLayoutStyle style; ///< 微博状态样式


//____以下是布局结果_______
// 顶部留白
@property (assign, nonatomic) CGFloat topSpacingHeight;               ///< 顶部灰色留白

// 标题栏
@property (assign, nonatomic) CGFloat titleHeight;              ///< 标题栏高度，没标题栏时值为0
@property (strong, nonatomic) YYTextLayout *titleTextLayout; // 标题栏布局

// 个人资料
@property (assign, nonatomic) CGFloat profileHeight;            ///< 个人资料高度（包括留白）
...
// 下边留白
@property (nonatomic, assign) CGFloat bottomSpacingHeight;            ///< 下边留白
