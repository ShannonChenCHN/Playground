...
#define kShareDescLabelWidth                    POINT_FROM_PIXEL(340)
...
- (void)p_addSubviews {
    ...
    // title view
    UIImageView *titleView = [[UIImageView alloc] initWithFrame:CGRectMake(kLeftRightPadding,
                                                                           POINT_FROM_PIXEL(21),
                                                                           kContentWidth,
                                                                           kTitleViewHeight)];
    ...
    textLabel.height = [textLabel.text sc_widthForFont:textLabel.font maxWidth:kContentWidth];
