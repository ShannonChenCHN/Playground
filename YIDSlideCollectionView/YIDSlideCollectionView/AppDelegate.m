...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UIFont *barButtonFont = [UIFont systemFontOfSize:13];
    [[UIBarButtonItem appearance] setTitleTextAttributes:@{NSFontAttributeName : barButtonFont}
                                                forState:UIControlStateNormal];
    
    UINavigationBar *navigationBar = [UINavigationBar appearanceWhenContainedInInstancesOfClasses:@[[UINavigationBar class]]];
